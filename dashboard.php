...
<head>
  ...
  <title>Daisy Klinik Bootstrap Template - Index</title>
  ...
  <!-- =======================================================
  * Template Name: Daisy Klinik
  * Updated: Sep 18 2023 with Bootstrap v5.3.2
  * Template URL: https://bootstrapmade.com/Daisy Klinik-free-bootstrap-theme/
...
<body>
  ...
  <div id="topbar" class="d-flex align-items-center fixed-top">
    <div class="container d-flex align-items-center justify-content-center justify-content-md-between">
      ...
      <div class="d-flex align-items-center">
        <i class="bi bi-phone"></i> Call us now +62 888 999 000
      </div>
    </div>
  </div>
  ...
  <header id="header" class="fixed-top">
    <div class="container d-flex align-items-center">
      ...
      <a href="index.html" class="logo me-auto"><img src="" alt="">Daisy Klinik</a>
      <!-- Uncomment below if you prefer to use an image logo -->
      <!-- <h1 class="logo me-auto"><a href="index.html">Daisy Klinik</a></h1> -->

      <nav id="navbar" class="navbar order-last order-lg-0">
        <ul>
          <li><a class="nav-link scrollto " href="#hero">Home</a></li>
          <li><a class="nav-link scrollto" href="#about">About</a></li>
          <li><a class="nav-link scrollto" href="#departments">Employee</a></li>
          <li><a class="nav-link scrollto" href="#doctors">Doctor's schedule</a></li>
      ...
      <a href="#appointment" class="appointment-btn scrollto"><span class="d-none d-md-inline">Logout</span>
    ...
    <div id="heroCarousel" data-bs-interval="5000" class="carousel slide carousel-fade" data-bs-ride="carousel">
      ...
      <div class="carousel-inner" role="listbox">
        ...
        <div class="carousel-item active" style="background-image: url(assets/img/slide/slide-1.jpg)">
          <div class="container">
            <h2>Welcome to <span>Daisy Klinik</span></h2>
        ...
        <div class="carousel-item" style="background-image: url(assets/img/slide/slide-3.jpg)">
          <div class="container">
            <h2>HALLO SELAMAT DATANG DI DAISY KLINIK</h2>
            <p>Melayani dengan sepenuh hati. Dari masyarakat dan untuk masyarakat</p>
  ...
  <footer id="footer">
    ...
    <div class="container">
      <div class="copyright">
        &copy; Copyright <strong><span>Klinik Daisy</span></strong>. All Rights Reserved
      </div>
      <div class="credits">
        <!-- All the links in the footer should remain intact. -->
        <!-- You can delete the links only if you purchased the pro version. -->
        <!-- Licensing information: https://bootstrapmade.com/license/ -->
        <!-- Purchase the pro version with working PHP/AJAX contact form: https://bootstrapmade.com/Daisy Klinik-free-bootstrap-theme/ -->
